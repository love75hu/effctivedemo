...
public class DA_GA_JiBenXXDto {
    ...
    private List<DA_GA_GuoMinShiDto> guoMinShi;

    /**
     * 暴露史
     */
    @Schema(description = "暴露史")
    private List<DA_GA_BaoLuShiDto> baoLuShi;

    /**
     * 疾病史
     */
    @Schema(description = "疾病史")
    private List<DA_GA_JiBingShiDto> jiBingShi;

    /**
     * 家族史
     */
    @Schema(description = "家族史")
    private List<DA_GA_JiaZuShiDto> jiaZuShi;

    /**
     * 手术史
     */
    @Schema(description = "手术史")
    private List<DA_GA_ShouShuShiDto> shouShuShi;

    /**
     * 外伤史
     */
    @Schema(description = "外伤史")
    private List<DA_GA_WaiShangShiDto> waiShangShi;

    /**
     * 输血史
     */
    @Schema(description = "输血史")
    private List<DA_GA_ShuXueShiDto> shuXueShi;

    /**
     * 残疾情况
     */
    @Schema(description = "残疾情况")
    private List<DA_GA_CanJiQKDto> canJiQK;
}
