...
public interface SC_BH_JieDianSXRepository extends MsfJpaRepository<QSC_BH_JieDianSXModel, SC_BH_JieDianSXModel, String>, JpaSpecificationExecutor<SC_BH_JieDianSXModel> {
    ...
    List<SC_BH_JieDianSXModel>  findByBiHuanIDAndZuZhiJGID(String biHuanID,String zuZhiJGID);

    List<SC_BH_JieDianSXModel> findByBiHuanIDIn(List<String> biHuanID);

    List<SC_BH_JieDianSXModel> findByBiHuanID(String biHuanID);
