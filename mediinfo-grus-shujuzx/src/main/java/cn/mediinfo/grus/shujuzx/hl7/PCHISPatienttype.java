...
/**
 * <p>PCHIS.Patienttype complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>{@code
 * <complexType name="PCHIS.Patienttype">
 *   <complexContent>
 ...
 *         <element name="patienttypeCode" type="{urn:hl7-org:v3}CE"/>
 *       </sequence>
...
@XmlType(name = "PCHIS.Patienttype", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "patienttypeCode"
})
public class PCHISPatienttype {

    protected List<CS> realmCode;
    protected POCDMT000040InfrastructureRootTypeId typeId;
    protected List<II> templateId;
    @XmlElement(required = true)
    protected CE patienttypeCode;
     ...
     *     
     */
    public void setPatienttypeCode(CE value) {
