...
/**
 * <p>PCHIS.Employerorganization complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>{@code
 * <complexType name="PCHIS.Employerorganization">
 *   <complexContent>
...
@XmlType(name = "PCHIS.Employerorganization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class PCHISEmployerorganization {
